<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Total Product Quantity</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12" style="margin: auto;">
            <div class="tile">
                <h3 class="tile-title">Total Product Quantity</h3>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    $(function() {
        ...
        function ajaxlist(page_url = false)
        {
            ...
            var base_url = '<?php echo site_url('DashboardController/quantity_ajax/') ?>';
